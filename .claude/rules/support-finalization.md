---
# AUTO-GENERATED from .github/instructions/support-finalization.instructions.md — do not edit
paths:
  - "scripts/Install-PitCrewSupportPlane.ps1"
  - "src/PitCrew.Support.Agent.App/{Program,SupportAgentSettingsFinalizer,SupportEnrollmentFinalizationRequestWorker}.cs"

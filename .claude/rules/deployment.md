---
# AUTO-GENERATED from .github/instructions/deployment.instructions.md — do not edit
paths:
  - "Dockerfile"
  - "src/PitCrew.Connector.App/Dockerfile"
  - "docker-compose*.yml"
  - "deploy/**"
  - ".container/**"
  - "scripts/container/**"
  - ".github/workflows/{container-ci,publish-container,publish-host-connector}.yml"
---
...
- Use the complete hosted base-plus-ingress Compose model for lifecycle operations.
  Do not publish the dashboard service directly or bypass ingress dependency
  coordination.

...
Add-Check (
    ...
    $policy.pitCrewVersion -eq '0.10.18'
) 'The evidence ACL policy is not pinned to PitCrew v0.10.18 contract v3.'
Add-Check (
...
) 'The evidence ACL policy is not pinned to the verified PitCrew v0.10.18 collector commit.'
Add-Check (

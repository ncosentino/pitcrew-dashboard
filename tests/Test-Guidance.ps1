...
try {
    ...
    Add-Check ($result.docs -eq 49) (
        'The documentation map does not contain the expected 49 maintained pages.')
    Add-Check ($result.adrs -eq 11) (
        'The ADR index does not contain eleven records.')

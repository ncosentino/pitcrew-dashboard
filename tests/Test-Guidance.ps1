...
try {
    ...
    Add-Check ($result.docs -eq 53) (
        'The documentation map does not contain the expected 53 maintained pages.')
    Add-Check ($result.adrs -eq 13) (
        'The ADR index does not contain thirteen records.')

...
try {
    ...
    Add-Check ($result.docs -eq 48) (
        'The documentation map does not contain the expected 48 maintained pages.')
    Add-Check ($result.adrs -eq 10) (
        'The ADR index does not contain ten records.')

...
try {
    ...
    Add-Check ($result.docs -eq 57) (
        'The documentation map does not contain the expected 57 maintained pages.')
    Add-Check ($result.adrs -eq 16) (
        'The ADR index does not contain sixteen records.')

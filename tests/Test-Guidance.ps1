...
try {
    ...
    Add-Check ($result.docs -eq 46) (
        'The documentation map does not contain the expected 46 maintained pages.')
    Add-Check ($result.adrs -eq 9) (
        'The ADR index does not contain nine records.')

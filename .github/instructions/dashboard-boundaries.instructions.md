---
applyTo: "src/PitCrew.Protocol/**/*.cs,src/PitCrew.Connector.Features.Sync/**/*.cs,src/PitCrew.Dashboard.Features.{Access,Fleet}/**/*.cs,src/PitCrew.Dashboard.Features.{Access,Fleet}.Abstractions/**/*.cs,src/PitCrew.Dashboard.Kernel.*/**/*.cs"
---

---
applyTo: "Dockerfile,src/PitCrew.Connector.App/Dockerfile,docker-compose*.yml,deploy/**,.container/**,scripts/container/**,.github/workflows/{container-ci,publish-container,publish-host-connector}.yml"
---

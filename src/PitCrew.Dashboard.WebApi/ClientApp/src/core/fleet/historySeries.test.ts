...
function sample(overrides: Partial<ProfileTelemetrySample> = {}): ProfileTelemetrySample {
  return {
    ...
    hostAdmissionAllocatableUnits: null,
    hostAdmissionAllocatableWorkers: null,
    hostAdmissionTheoreticalMaximumUnits: null,
    hostAdmissionTheoreticalMaximumWorkers: null,
    hostAdmissionWithholdingReason: null,
    workerCpuCores: 1.5,
